...
public:
    ...
    {
        auto session = static_cast<AuthenticatorSession*>(client->authenticator_data);
        bool success = false;
...
public:
    ...
    static void* createSession(void* instance)
    {
        ...
        MXS_EXCEPTION_GUARD(ses = AuthImplementation::createSession());
        return ses;
    }

    static bool extractData(DCB* backend, GWBUF* buffer)
    {
        auto session = static_cast<AuthenticatorBackendSession*>(backend->authenticator_data);
        bool success = false;
...
{
        nullptr,
        &BackendAuthenticatorApi<AuthImplementation>::createSession,
        ...
        nullptr,
        &BackendAuthenticatorApi<AuthImplementation>::destroySession,
        nullptr,
        nullptr,
        nullptr,
        nullptr
